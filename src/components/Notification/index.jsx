    ...
    <Layout>
      <div className="notification-page w-full mb-10">
        <div className="notification-wrapper w-full">
          ...
          <div
            className={`w-full p-8  rounded-xl bg-white dark:bg-dark-white   ${
              selectTab === "today" ? "block" : "hidden"
            }`}
          >
            <ul>
              <li className="content-item py-4 border-b dark:border-[#5356fb29]  border-light-purple dark:border-[#5356fb29]  hover:border-purple">
